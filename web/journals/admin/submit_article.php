...
<TD ALIGN="RIGHT">
<textarea name=title cols=30 rows=3>$title</textarea>
</TD>
</TR>
<TR>
<TD VALIGN="TOP">
...
<TD ALIGN="RIGHT">
<textarea name=blurb cols=30 rows=3>$blurb</textarea>
</TD>
</TR>
...
if ( isset($article_id) ) {
    ...
    echo <<<EOT
<TR><TD COLSPAN=2>
<input type='hidden' name='type' value='resubmit'>
<input type='hidden' name='article_id' value='$article_id'>
<textarea name=update cols=53 rows=20 wrap=virtual>$text</textarea>\n<br>
</TD></TR>
</TABLE>
EOT;
} 
